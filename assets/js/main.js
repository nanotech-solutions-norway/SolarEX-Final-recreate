document.addEventListener('DOMContentLoaded', () => {
  ...
  loadCss(assetPath('assets/css/solarex-overrides.css?v=20260525-bars-layout-1'), 'data-solarex-overrides');
  loadCss(assetPath('assets/css/visual-upgrade.css?v=20260525-bars-layout-1'), 'data-solarex-visual-css');
  loadCss(assetPath('assets/css/solarex-cleanup.css?v=20260525-bars-layout-1'), 'data-solarex-cleanup-css');
  loadScript(assetPath('assets/js/visual-upgrade.js?v=20260525-bars-layout-1'), 'data-solarex-visual-js');
  loadScript(assetPath('assets/js/solarex-cleanup.js?v=20260525-bars-layout-1'), 'data-solarex-cleanup-js');
